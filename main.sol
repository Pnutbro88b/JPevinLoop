...
contract JPevinLoop {
    ...
    function readPool_3(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_4(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_5(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_6(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_7(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_8(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_9(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_10(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_11(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_12(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_13(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_14(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_23(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_24(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_25(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_26(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_27(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_28(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_29(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function readPool_30(uint64 poolId)
        external
        view
        returns (
            bytes32 strategyRoot,
    ...
    function batchPoolStatus_5(uint64[] calldata poolIds)
        external
        view
        returns (uint8[] memory statuses, uint256[] memory assets, uint256[] memory shares)
    {
    ...
    function batchPoolStatus_6(uint64[] calldata poolIds)
        external
        view
        returns (uint8[] memory statuses, uint256[] memory assets, uint256[] memory shares)
    {
    ...
    function batchPoolStatus_7(uint64[] calldata poolIds)
        external
        view
        returns (uint8[] memory statuses, uint256[] memory assets, uint256[] memory shares)
    {
    ...
    function batchPoolStatus_8(uint64[] calldata poolIds)
        external
        view
        returns (uint8[] memory statuses, uint256[] memory assets, uint256[] memory shares)
    {
    ...
    function batchPoolStatus_9(uint64[] calldata poolIds)
        external
        view
        returns (uint8[] memory statuses, uint256[] memory assets, uint256[] memory shares)
    {
    ...
    function batchPoolStatus_10(uint64[] calldata poolIds)
        external
        view
        returns (uint8[] memory statuses, uint256[] memory assets, uint256[] memory shares)
    {
    ...
    function batchPoolStatus_11(uint64[] calldata poolIds)
        external
        view
        returns (uint8[] memory statuses, uint256[] memory assets, uint256[] memory shares)
    {
    ...
    function batchPoolStatus_12(uint64[] calldata poolIds)
        external
        view
        returns (uint8[] memory statuses, uint256[] memory assets, uint256[] memory shares)
    {
    ...
    function batchPoolStatus_13(uint64[] calldata poolIds)
        external
        view
        returns (uint8[] memory statuses, uint256[] memory assets, uint256[] memory shares)
    {
    ...
    function batchPoolStatus_14(uint64[] calldata poolIds)
        external
        view
        returns (uint8[] memory statuses, uint256[] memory assets, uint256[] memory shares)
    {
